...
def render_pomodoro_q1():
    ...
    with col_2:
        ...
        st.markdown(
            ...
            management is a crucial part of surviving this island. So let's have a look at your tasks again. Looks like 
            the pirate has already sorted them for you in the order that he would recommend. The only thing left for you 
            to do is to think about how much time you need for the individual tasks. Fill out the time slots in hours 
            and minutes by either selecting one of the suggested times or by writing them down in the slots. <br>For example it takes 
            me about 23 minutes to clean my shell. So I would put in 00:23 for this task.</p>""",
            unsafe_allow_html=True
        )
    ...
    with col3:
        st.markdown(f""" <p style="text-align:right; font-size:1.7vw; line-height: 194%;">Search for drinking water<br>Build a Shelter<br>Serach for food</p> """,
                    unsafe_allow_html=True)
    ...
    with col5:
        st.markdown(f""" <p style="text-align:right; font-size:1.7vw; line-height: 194%;">Collect Wood<br>Build a fire<br>Search for a container (for water or food)</p> """,
                    unsafe_allow_html=True)
    ...
    with col7:
        st.markdown(f""" <p style="text-align:right; font-size:1.7vw; line-height: 194%;">Build a weapon<br>Explore the surroundings<br>Collect Shells</p> """,
                    unsafe_allow_html=True)
