...
def render_pomodoro_q2():
    ...
    st.divider()
    st.markdown(f"""
    <p style="text-align: center; line-height:130%; font-size: 1.5vw; color: white">🍅  =  1 Pomodoro  =  25 minutes of focused work session  +  5 minutes break</p>
    """, unsafe_allow_html=True)

    col3, col4, col5, col6 = st.columns((2, 1,1, 3))
    with col3:
        st.markdown(
            f""" <p style="text-align:right; font-size:1.7vw; line-height: 194%;">Search for drinking water<br>Build a Shelter<br>Serach for food<br>Collect Wood<br>Build a fire<br>Search for a container (for water or food)<br>Build a weapon<br>Explore the surroundings<br>Collect Shells<br>Watch the Sunset</p> """,
            unsafe_allow_html=True)
    with col4:
